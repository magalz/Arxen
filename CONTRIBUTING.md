...
[docs/testing.md](docs/testing.md) para o fluxo de testes. A E00.3 está integrada;
a entrega atual é a E00.4, descrita no
[plano da fundação](docs/e00-foundation-plan.md) e nos
[slices de conversa persistente](docs/e00-4-persistent-conversation.md). Envio,
histórico e reenvios idempotentes estão implementados e dependem das evidências,
review independente e CI do SHA final registrados na PR. E00.5 e E01 não começaram.
